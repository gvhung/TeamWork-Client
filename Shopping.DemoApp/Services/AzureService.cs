...
namespace TeamWork
{
    public class AzureService
	{
		...
		public MobileServiceClient Client
		{
			get
			{
				if(_client == null)
				{
					...
					_client = new MobileServiceClient(AppSettings.ApiAddress, new HttpMessageHandler[] {
						handler,
					});
				}

				_client.AlternateLoginHost = new Uri(AppSettings.ApiAddress);
				return _client;
			}			
		}
		...
		public async Task<bool> SyncAllAsync()
		{
			...
			list.Add(ProductManager.SyncAsync());
